...
def list():
    ...
    if form.validate_on_submit():
        ...
        if list_name is None:
            new_list = List(name=form.list.data, category = form.category.data, priority = form.priority.data, colorR = form.colorR.data, colorG = form.colorG.data, colorB = form.colorB.data, due = form.end.data, user = current_user)
